 ...
 * Page class
 */
class ContractServicesView extends ContractServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContractServicesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContractServicesView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("contract_id") ?? Route("contract_id")) !== null) {
            $this->RecKey["contract_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("contract_id") ?? Route("contract_id")) !== null) {
            ...
            $this->RecKey["contract_id"] = $this->contract_id->QueryStringValue;
        } elseif (Post("contract_id") !== null) {
            $this->contract_id->setFormValue(Post("contract_id"));
            $this->RecKey["contract_id"] = $this->contract_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->contract_id->setQueryStringValue($keyValue);
            $this->RecKey["contract_id"] = $this->contract_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ContractServicesList"; // Return to list
        }
        if (($keyValue = Get("service_id") ?? Route("service_id")) !== null) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ContractServicesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
