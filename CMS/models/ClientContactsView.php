 ...
 * Page class
 */
class ClientContactsView extends ClientContacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientContactsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientContactsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("contact_id") ?? Route("contact_id")) !== null) {
            $this->RecKey["contact_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        } elseif (Post("contact_id") !== null) {
            $this->contact_id->setFormValue(Post("contact_id"));
            $this->RecKey["contact_id"] = $this->contact_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->contact_id->setQueryStringValue($keyValue);
            $this->RecKey["contact_id"] = $this->contact_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ClientContactsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ClientContactsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
