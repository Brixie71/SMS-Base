 ...
 * Page class
 */
class ClientContractsView extends ClientContracts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientContractsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientContractsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("contract_id") ?? Route("contract_id")) !== null) {
            ...
            $returnUrl = "ClientContractsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ClientContractsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
