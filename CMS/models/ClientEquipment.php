...
/**
 * Table class for client_equipment
 */
class ClientEquipment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "client_equipment";
        ...
        // tower_equipment_id
        $this->tower_equipment_id = new DbField(
            $this, // Table
            'x_tower_equipment_id', // Variable name
            'tower_equipment_id', // Name
            '"tower_equipment_id"', // Expression
            'CAST("tower_equipment_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"tower_equipment_id"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tower_equipment_id->InputTextType = "text";
        $this->tower_equipment_id->Raw = true;
        $this->tower_equipment_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->tower_equipment_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['tower_equipment_id'] = &$this->tower_equipment_id;
        ...
        $this->installation_date = new DbField(
            ...
            CastDateFieldForLike("\"installation_date\"", 0, "philtower_cms"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        // removal_date
        $this->removal_date = new DbField(
            $this, // Table
            'x_removal_date', // Variable name
            'removal_date', // Name
            '"removal_date"', // Expression
            CastDateFieldForLike("\"removal_date\"", 0, "philtower_cms"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"removal_date"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->removal_date->InputTextType = "text";
        $this->removal_date->Raw = true;
        $this->removal_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->removal_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['removal_date'] = &$this->removal_date;
        ...
        $this->maintenance_schedule = new DbField(
            $this, // Table
            'x_maintenance_schedule', // Variable name
            'maintenance_schedule', // Name
            '"maintenance_schedule"', // Expression
            '"maintenance_schedule"', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"maintenance_schedule"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->maintenance_schedule->InputTextType = "text";
        $this->maintenance_schedule->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['maintenance_schedule'] = &$this->maintenance_schedule;

        // last_maintenance_date
        $this->last_maintenance_date = new DbField(
            $this, // Table
            'x_last_maintenance_date', // Variable name
            'last_maintenance_date', // Name
            '"last_maintenance_date"', // Expression
            CastDateFieldForLike("\"last_maintenance_date\"", 0, "philtower_cms"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"last_maintenance_date"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->last_maintenance_date->InputTextType = "text";
        $this->last_maintenance_date->Raw = true;
        $this->last_maintenance_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->last_maintenance_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['last_maintenance_date'] = &$this->last_maintenance_date;
        ...
        $this->next_maintenance_date = new DbField(
            ...
            CastDateFieldForLike("\"next_maintenance_date\"", 0, "philtower_cms"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "client_equipment";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->tower_equipment_id->DbValue = $row['tower_equipment_id'];
        $this->installation_date->DbValue = $row['installation_date'];
        $this->removal_date->DbValue = $row['removal_date'];
        $this->status->DbValue = $row['status'];
        $this->maintenance_schedule->DbValue = $row['maintenance_schedule'];
        $this->last_maintenance_date->DbValue = $row['last_maintenance_date'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ClientEquipmentList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ClientEquipmentView" => $Language->phrase("View"),
            "ClientEquipmentEdit" => $Language->phrase("Edit"),
            "ClientEquipmentAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ClientEquipmentView",
            Config("API_ADD_ACTION") => "ClientEquipmentAdd",
            Config("API_EDIT_ACTION") => "ClientEquipmentEdit",
            Config("API_DELETE_ACTION") => "ClientEquipmentDelete",
            Config("API_LIST_ACTION") => "ClientEquipmentList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ClientEquipmentView", $parm);
        } else {
            $url = $this->keyUrl("ClientEquipmentView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ClientEquipmentAdd?" . $parm;
        } else {
            $url = "ClientEquipmentAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClientEquipmentEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClientEquipmentList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClientEquipmentAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClientEquipmentList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ClientEquipmentDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->removal_date->EditValue = FormatDateTime($this->removal_date->CurrentValue, $this->removal_date->formatPattern());
        ...
        $this->maintenance_schedule->EditValue = $this->maintenance_schedule->CurrentValue;
        ...
        $this->last_maintenance_date->EditValue = FormatDateTime($this->last_maintenance_date->CurrentValue, $this->last_maintenance_date->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->tower_equipment_id);
                    $doc->exportCaption($this->installation_date);
                    $doc->exportCaption($this->removal_date);
                    $doc->exportCaption($this->status);
                    $doc->exportCaption($this->maintenance_schedule);
                    $doc->exportCaption($this->last_maintenance_date);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->tower_equipment_id);
                        $doc->exportField($this->installation_date);
                        $doc->exportField($this->removal_date);
                        $doc->exportField($this->status);
                        $doc->exportField($this->maintenance_schedule);
                        $doc->exportField($this->last_maintenance_date);
