 ...
 * Page class
 */
class ClientsDelete extends Clients
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ClientsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ClientsList"); // Return to list
                return;
            }
        }
