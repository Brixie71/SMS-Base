 ...
 * Page class
 */
class ServiceTypesView extends ServiceTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("service_id") ?? Route("service_id")) !== null) {
            ...
            $returnUrl = "ServiceTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ServiceTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
