 ...
 * Page class
 */
class SupportTicketsDelete extends SupportTickets
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SupportTicketsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "SupportTicketsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SupportTicketsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("SupportTicketsList"); // Return to list
                return;
            }
        }
