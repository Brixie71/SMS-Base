...
/**
 * Table class for audit_logs
 */
class AuditLogs extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // date_time
        $this->date_time = new DbField(
            $this, // Table
            'x_date_time', // Variable name
            'date_time', // Name
            '"date_time"', // Expression
            CastDateFieldForLike("\"date_time\"", 0, "DB"), // Basic search expression
            135, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"date_time"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->date_time->InputTextType = "text";
        $this->date_time->Raw = true;
        $this->date_time->Nullable = false; // NOT NULL field
        $this->date_time->Required = true; // Required field
        $this->date_time->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->date_time->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        // key_value
        $this->key_value = new DbField(
            $this, // Table
            'x_key_value', // Variable name
            'key_value', // Name
            '"key_value"', // Expression
            '"key_value"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"key_value"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->key_value->InputTextType = "text";
        $this->key_value->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['key_value'] = &$this->key_value;

        // old_value
        $this->old_value = new DbField(
            $this, // Table
            'x_old_value', // Variable name
            'old_value', // Name
            '"old_value"', // Expression
            '"old_value"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"old_value"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->old_value->InputTextType = "text";
        $this->old_value->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['old_value'] = &$this->old_value;

        // new_value
        $this->new_value = new DbField(
            $this, // Table
            'x_new_value', // Variable name
            'new_value', // Name
            '"new_value"', // Expression
            '"new_value"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"new_value"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->new_value->InputTextType = "text";
        $this->new_value->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "audit_logs";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->date_time->DbValue = $row['date_time'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AuditLogsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "AuditLogsView" => $Language->phrase("View"),
            "AuditLogsEdit" => $Language->phrase("Edit"),
            "AuditLogsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "AuditLogsView",
            Config("API_ADD_ACTION") => "AuditLogsAdd",
            Config("API_EDIT_ACTION") => "AuditLogsEdit",
            Config("API_DELETE_ACTION") => "AuditLogsDelete",
            Config("API_LIST_ACTION") => "AuditLogsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AuditLogsView", $parm);
        } else {
            $url = $this->keyUrl("AuditLogsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AuditLogsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AuditLogsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AuditLogsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AuditLogsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AuditLogsDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->date_time->EditValue = FormatDateTime($this->date_time->CurrentValue, $this->date_time->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->date_time);
                    ...
                    $doc->exportCaption($this->key_value);
                    $doc->exportCaption($this->old_value);
                    $doc->exportCaption($this->new_value);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->date_time);
                    $doc->exportCaption($this->script);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->date_time);
                        ...
                        $doc->exportField($this->key_value);
                        $doc->exportField($this->old_value);
                        $doc->exportField($this->new_value);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->date_time);
                        $doc->exportField($this->script);
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'audit_logs');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'audit_logs', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'audit_logs', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'audit_logs', $fldname, $key, $oldvalue);
            }
        }
    }
