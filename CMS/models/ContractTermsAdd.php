 ...
 * Page class
 */
class ContractTermsAdd extends ContractTerms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContractTermsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ContractTermsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ContractTermsView") {
    ...
    protected function getAddRow()
    {
        ...
        // contract_id
        $this->contract_id->setDbValueDef($rsnew, $this->contract_id->CurrentValue, false);

        // term_type
        $this->term_type->setDbValueDef($rsnew, $this->term_type->CurrentValue, false);
        ...
        $this->is_mandatory->setDbValueDef($rsnew, $tmpBool, strval($this->is_mandatory->CurrentValue) == "");
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['contract_id'])) { // contract_id
            $this->contract_id->setFormValue($row['contract_id']);
        }
        if (isset($row['term_type'])) { // term_type
            $this->term_type->setFormValue($row['term_type']);
        }
        ...
        if (isset($row['is_mandatory'])) { // is_mandatory
            $this->is_mandatory->setFormValue($row['is_mandatory']);
        }
    }
