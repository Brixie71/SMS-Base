 ...
 * Page class
 */
class ClientTypesView extends ClientTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("type_id") ?? Route("type_id")) !== null) {
            ...
            $returnUrl = "ClientTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ClientTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
