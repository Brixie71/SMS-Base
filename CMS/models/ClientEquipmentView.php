 ...
 * Page class
 */
class ClientEquipmentView extends ClientEquipment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientEquipmentView";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientEquipmentView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("equipment_id") ?? Route("equipment_id")) !== null) {
            ...
            $returnUrl = "ClientEquipmentList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ClientEquipmentList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
