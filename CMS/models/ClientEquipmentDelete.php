 ...
 * Page class
 */
class ClientEquipmentDelete extends ClientEquipment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientEquipmentDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientEquipmentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ClientEquipmentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ClientEquipmentList"); // Return to list
                return;
            }
        }
