 ...
 * Page class
 */
class ClientContractsDelete extends ClientContracts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientContractsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientContractsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ClientContractsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ClientContractsList"); // Return to list
                return;
            }
        }
