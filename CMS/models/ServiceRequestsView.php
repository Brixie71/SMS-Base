 ...
 * Page class
 */
class ServiceRequestsView extends ServiceRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceRequestsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceRequestsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("request_id") ?? Route("request_id")) !== null) {
            ...
            $returnUrl = "ServiceRequestsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ServiceRequestsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
