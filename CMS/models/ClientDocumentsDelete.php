 ...
 * Page class
 */
class ClientDocumentsDelete extends ClientDocuments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientDocumentsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientDocumentsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ClientDocumentsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ClientDocumentsList"); // Return to list
                return;
            }
        }
