 ...
 * Page class
 */
class SupportTicketsView extends SupportTickets
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SupportTicketsView";
    ...
    // CSS class/style
    public $CurrentPageName = "SupportTicketsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("ticket_id") ?? Route("ticket_id")) !== null) {
            $this->RecKey["ticket_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("ticket_id") ?? Route("ticket_id")) !== null) {
            ...
            $this->RecKey["ticket_id"] = $this->ticket_id->QueryStringValue;
        } elseif (Post("ticket_id") !== null) {
            $this->ticket_id->setFormValue(Post("ticket_id"));
            $this->RecKey["ticket_id"] = $this->ticket_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->ticket_id->setQueryStringValue($keyValue);
            $this->RecKey["ticket_id"] = $this->ticket_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "SupportTicketsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SupportTicketsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
