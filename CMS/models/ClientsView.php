...
class ClientsView extends Clients
{
    ...
    // Page object name
    public $PageObjName = "ClientsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("client_id") ?? Route("client_id")) !== null) {
            $this->RecKey["client_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("client_id") ?? Route("client_id")) !== null) {
            ...
            $returnUrl = "ClientsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ClientsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
