 ...
 * Page class
 */
class ContractServicesDelete extends ContractServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContractServicesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContractServicesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContractServicesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContractServicesList"); // Return to list
                return;
            }
        }
