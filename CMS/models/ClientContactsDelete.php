 ...
 * Page class
 */
class ClientContactsDelete extends ClientContacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientContactsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientContactsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ClientContactsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ClientContactsList"); // Return to list
                return;
            }
        }
