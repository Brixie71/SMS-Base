 ...
 * Page class
 */
class ClientDocumentsAdd extends ClientDocuments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientDocumentsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientDocumentsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ClientDocumentsView") {
    ...
    protected function getAddRow()
    {
        ...
        // upload_date
        $this->upload_date->setDbValueDef($rsnew, UnFormatDateTime($this->upload_date->CurrentValue, $this->upload_date->formatPattern()), false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['document_type'])) { // document_type
            $this->document_type->setFormValue($row['document_type']);
        }
        ...
        if (isset($row['upload_date'])) { // upload_date
            $this->upload_date->setFormValue($row['upload_date']);
        }
