 ...
 * Page class
 */
class ServiceRequestsDelete extends ServiceRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceRequestsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ServiceRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ServiceRequestsList"); // Return to list
                return;
            }
        }
