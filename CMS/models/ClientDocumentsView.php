 ...
 * Page class
 */
class ClientDocumentsView extends ClientDocuments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClientDocumentsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ClientDocumentsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("document_id") ?? Route("document_id")) !== null) {
            $this->RecKey["document_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("document_id") ?? Route("document_id")) !== null) {
            ...
            $returnUrl = "ClientDocumentsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ClientDocumentsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
