...
return [
    ...
    "client_contacts" => \DI\create(ClientContacts::class),
    "client_contracts" => \DI\create(ClientContracts::class),
    "client_documents" => \DI\create(ClientDocuments::class),
    "client_equipment" => \DI\create(ClientEquipment::class),
    "client_types" => \DI\create(ClientTypes::class),
    "clients" => \DI\create(Clients::class),
    "contract_services" => \DI\create(ContractServices::class),
    "contract_terms" => \DI\create(ContractTerms::class),
    "service_requests" => \DI\create(ServiceRequests::class),
    "service_types" => \DI\create(ServiceTypes::class),
    "support_ticket_updates" => \DI\create(SupportTicketUpdates::class),
    "support_tickets" => \DI\create(SupportTickets::class),
