...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/CMS.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\CMS\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\CMS\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-cms", // Export folder
