...
?>
<main class="edit">
<form name="fclient_equipmentedit" id="fclient_equipmentedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { client_equipment: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fclient_equipmentedit;
...
<?php if ($Page->equipment_id->Visible) { // equipment_id ?>
    <div id="r_equipment_id"<?= $Page->equipment_id->rowAttributes() ?>>
        <label id="elh_client_equipment_equipment_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->equipment_id->caption() ?><?= $Page->equipment_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="client_equipment" data-field="x_equipment_id" data-hidden="1" name="x_equipment_id" id="x_equipment_id" value="<?= HtmlEncode($Page->equipment_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fclient_equipmentedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fclient_equipmentedit", "x_installation_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fclient_equipmentedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fclient_equipmentedit", "x_removal_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fclient_equipmentedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fclient_equipmentedit", "x_last_maintenance_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fclient_equipmentedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fclient_equipmentedit", "x_next_maintenance_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fclient_equipmentedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fclient_equipmentedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
