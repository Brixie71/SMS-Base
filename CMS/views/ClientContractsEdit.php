...
?>
<main class="edit">
<form name="fclient_contractsedit" id="fclient_contractsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { client_contracts: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fclient_contractsedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fclient_contractsedit")
        .setPageId("edit")

        // Add fields
        .setFields([
            ["contract_id", [fields.contract_id.visible && fields.contract_id.required ? ew.Validators.required(fields.contract_id.caption) : null], fields.contract_id.isInvalid],
...
<?php if ($Page->contract_id->Visible) { // contract_id ?>
    <div id="r_contract_id"<?= $Page->contract_id->rowAttributes() ?>>
        <label id="elh_client_contracts_contract_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->contract_id->caption() ?><?= $Page->contract_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="client_contracts" data-field="x_contract_id" data-hidden="1" name="x_contract_id" id="x_contract_id" value="<?= HtmlEncode($Page->contract_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fclient_contractsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fclient_contractsedit", "x_start_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fclient_contractsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fclient_contractsedit", "x_end_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fclient_contractsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fclient_contractsedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fclient_contractsedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fclient_contractsedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
