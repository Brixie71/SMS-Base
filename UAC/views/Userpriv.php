...
window.Tabulator || loadjs([
    ew.PATH_BASE + "css/<?= CssFile("tabulator_bootstrap5.css", false) ?>?v=24.16.7",
    ew.PATH_BASE + "js/tabulator.min.js?v=24.16.7"
], "tabulator");
</script>
<style>
main .tooltip {
...
<script>
ew.ready(["load", "tabulator"], ew.PATH_BASE + "js/userpriv.min.js?v=24.16.7");
</script>
