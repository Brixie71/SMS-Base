 ...
 * Page class
 */
class AuditLogsEdit extends AuditLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AuditLogsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AuditLogsEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // date_time
        $this->date_time->setDbValueDef($rsnew, UnFormatDateTime($this->date_time->CurrentValue, $this->date_time->formatPattern()), $this->date_time->ReadOnly);
        ...
        // key_value
        $this->key_value->setDbValueDef($rsnew, $this->key_value->CurrentValue, $this->key_value->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['date_time'])) { // date_time
            $this->date_time->CurrentValue = $row['date_time'];
        }
        ...
        if (isset($row['key_value'])) { // key_value
            $this->key_value->CurrentValue = $row['key_value'];
        }
        if (isset($row['old_value'])) { // old_value
            $this->old_value->CurrentValue = $row['old_value'];
        }
        if (isset($row['new_value'])) { // new_value
            $this->new_value->CurrentValue = $row['new_value'];
        }
    }
