...
class UserLevelsView extends UserLevels
{
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("UserLevelAssignmentsList?" . Config("TABLE_SHOW_MASTER") . "=_user_levels&" . GetForeignKeyUrl("fk_user_level_id", $this->user_level_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("UserLevelAssignmentsGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'user_levels')) {
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'user_levels')) {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("UsersList?" . Config("TABLE_SHOW_MASTER") . "=_user_levels&" . GetForeignKeyUrl("fk_user_level_id", $this->user_level_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
