 ...
 * Page class
 */
class AuditLogsView extends AuditLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AuditLogsView";
    ...
    // CSS class/style
    public $CurrentPageName = "AuditLogsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AuditLogsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AuditLogsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
