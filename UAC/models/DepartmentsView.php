...
class DepartmentsView extends Departments
{
    ...
    // Page object name
    public $PageObjName = "DepartmentsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DepartmentsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("department_id") ?? Route("department_id")) !== null) {
            ...
            $returnUrl = "DepartmentsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DepartmentsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("UsersList?" . Config("TABLE_SHOW_MASTER") . "=departments&" . GetForeignKeyUrl("fk_department_id", $this->department_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("UsersGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'departments')) {
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'departments')) {
