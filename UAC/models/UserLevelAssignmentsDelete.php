 ...
 * Page class
 */
class UserLevelAssignmentsDelete extends UserLevelAssignments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevelAssignmentsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "UserLevelAssignmentsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserLevelAssignmentsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("UserLevelAssignmentsList"); // Return to list
                return;
            }
        }
