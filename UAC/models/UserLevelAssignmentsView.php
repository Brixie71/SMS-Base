 ...
 * Page class
 */
class UserLevelAssignmentsView extends UserLevelAssignments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevelAssignmentsView";
    ...
    // CSS class/style
    public $CurrentPageName = "UserLevelAssignmentsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("assignment_id") ?? Route("assignment_id")) !== null) {
            $this->RecKey["assignment_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("assignment_id") ?? Route("assignment_id")) !== null) {
            ...
            $this->RecKey["assignment_id"] = $this->assignment_id->QueryStringValue;
        } elseif (Post("assignment_id") !== null) {
            $this->assignment_id->setFormValue(Post("assignment_id"));
            $this->RecKey["assignment_id"] = $this->assignment_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->assignment_id->setQueryStringValue($keyValue);
            $this->RecKey["assignment_id"] = $this->assignment_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "UserLevelAssignmentsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UserLevelAssignmentsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
