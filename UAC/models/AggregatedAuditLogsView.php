 ...
 * Page class
 */
class AggregatedAuditLogsView extends AggregatedAuditLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AggregatedAuditLogsView";
    ...
    // CSS class/style
    public $CurrentPageName = "AggregatedAuditLogsView";
    ...
    public function __construct()
    {
        ...
        // Set up record key
        if (($keyValue = Get("aggregated_id") ?? Route("aggregated_id")) !== null) {
            $this->RecKey["aggregated_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("aggregated_id") ?? Route("aggregated_id")) !== null) {
            $this->aggregated_id->setQueryStringValue($keyValue);
            $this->RecKey["aggregated_id"] = $this->aggregated_id->QueryStringValue;
        } elseif (Post("aggregated_id") !== null) {
            $this->aggregated_id->setFormValue(Post("aggregated_id"));
            $this->RecKey["aggregated_id"] = $this->aggregated_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->aggregated_id->setQueryStringValue($keyValue);
            $this->RecKey["aggregated_id"] = $this->aggregated_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AggregatedAuditLogsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AggregatedAuditLogsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AggregatedAuditLogsList"), "", $this->TableVar, true);
        $pageId = "view";
