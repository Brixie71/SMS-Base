 ...
 * Page class
 */
class AuditLogsDelete extends AuditLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AuditLogsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AuditLogsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AuditLogsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AuditLogsList"); // Return to list
                return;
            }
        }
