 ...
 * Page class
 */
class UserLevelAssignmentsAdd extends UserLevelAssignments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevelAssignmentsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "UserLevelAssignmentsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "UserLevelAssignmentsView") {
