 ...
 * Page class
 */
class DepartmentsDelete extends Departments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepartmentsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DepartmentsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DepartmentsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DepartmentsList"); // Return to list
                return;
            }
        }
