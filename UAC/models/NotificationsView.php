 ...
 * Page class
 */
class NotificationsView extends Notifications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotificationsView";
    ...
    // CSS class/style
    public $CurrentPageName = "NotificationsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "NotificationsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NotificationsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
