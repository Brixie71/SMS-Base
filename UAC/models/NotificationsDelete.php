 ...
 * Page class
 */
class NotificationsDelete extends Notifications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotificationsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NotificationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NotificationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NotificationsList"); // Return to list
                return;
            }
        }
