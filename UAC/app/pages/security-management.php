...
async function loadSystems() {
    try {
        const response = await fetch('/UAC/api/permission/systems', {             
            headers: { 
...
async function loadUserLevels() {
    try {
        const response = await fetch(`/UAC/api/permission/userlevels/${currentSystem}`, {
            headers: { 
                'Content-Type': 'application/json',
                'X-Authorization': 'Bearer ' + ew.API_JWT_TOKEN 
            }
...
async function loadPermissions() {
    try {
        const response = await fetch(`/UAC/api/permission/${currentSystem}/${currentUserLevel}`, {
            headers: { 
                'Content-Type': 'application/json',
                'X-Authorization': 'Bearer ' + ew.API_JWT_TOKEN 
            }
...
async function savePermissions() {
    ...
    try {
        const response = await fetch('/UAC/api/permission', {
            method: 'POST',
            headers: { 
                'Content-Type': 'application/json',
                'X-Authorization': 'Bearer ' + ew.API_JWT_TOKEN 
