...
Type::addType("geometry", "PHPMaker2024\\UAC\\GeometryType"); // "geometry" type
Type::addType("geography", "PHPMaker2024\\UAC\\GeographyType"); // "geography" type
Type::addType("hierarchyid", "PHPMaker2024\\UAC\\HierarchyIdType"); // "hierarchyid" type
Type::addType("bytes", "PHPMaker2024\\UAC\\BytesType"); // "bytes" type
