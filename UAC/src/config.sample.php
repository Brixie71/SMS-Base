...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "POSTGRESQL", "qs" => "\"", "qe" => "\"", "host" => "localhost", "port" => "5432", "user" => "postgres", "password" => "0yq5h3to9", "dbname" => "philtower_uac", "schema" => "public"]
    ],
    "SMTP" => [
    ...
    "UPLOAD_TEMP_PATH" => "D:/PROJECTS/PHILTOWER/SECURITY-SYSTEM/temp_uploads", // Upload temp path (absolute local physical path)
    "UPLOAD_TEMP_HREF_PATH" => "//philtower-prime.localhost/temp_uploads/", // Upload temp href path (absolute URL path for download)
    "UPLOAD_DEST_PATH" => "s3://pg-itbs-dev/NLEX/" // Upload destination path (relative to app root)
