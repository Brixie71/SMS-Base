...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "24.16.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "UAC"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{UAC}"); // Project ID
