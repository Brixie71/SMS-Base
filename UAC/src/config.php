...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/UAC.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "XLQL2q7o8P454fA6ykhxqSJiQZJfqzh//tACuFlqVus=", // AES encryption key (base64 encoded)
    ...
    "JAVASCRIPT_FILES" => ["../_shared/js/custom.js","../_shared/js/mqtt-notification.js"],

    // External StyleSheets
    "STYLESHEET_FILES" => ["../_shared/css/custom.css"],
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\UAC\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\UAC\\Saml2',
    ...
    "AUDIT_TRAIL_TABLE_NAME" => "audit_logs", // Table name
    "AUDIT_TRAIL_TABLE_VAR" => "audit_logs", // Table var
    "AUDIT_TRAIL_FIELD_NAME_DATETIME" => "date_time", // DateTime field name
    ...
    "AUDIT_TRAIL_FIELD_NAME_KEYVALUE" => "key_value", // Key Value field name
    "AUDIT_TRAIL_FIELD_NAME_OLDVALUE" => "old_value", // Old Value field name
    "AUDIT_TRAIL_FIELD_NAME_NEWVALUE" => "new_value", // New Value field name

    // Export Log
    "EXPORT_PATH" => "export-uac", // Export folder
    ...
    "ADMIN_PASSWORD" => "0yq5h3to9", // Administrator password
    ...
    "USER_LEVEL_PRIV_TABLE" => "user_level_permissions",
    ...
    // Email
    "SENDER_EMAIL" => "phatneglo@yahoo.com", // Sender email address
    ...
    // File upload
    "UPLOAD_TEMP_PATH" => "D:/Projects/PHILTOWER/SECURITY-SYSTEM/tmp_uploads", // Upload temp path (absolute local physical path)
    "UPLOAD_TEMP_HREF_PATH" => "//philtower-prime.local/temp_uploads", // Upload temp href path (absolute URL path for download)
