...
const NotificationManager = {
    ...
    async updateNotifications() {
        try {
            const response = await fetch('/UAC/api/notifications/recent', {
                headers: {
    ...
    async markAsRead(event, notificationId) {
        try {
            const response = await fetch('/UAC/api/notifications/mark-read', {
                method: 'POST',
                headers: {
                    'Authorization': 'Bearer ' + ew.API_JWT_TOKEN,
    ...
    async markAllRead(event) {
        ...
        try {
            const response = await fetch('/UAC/api/notifications/mark-all-read', {
                method: 'POST',
                headers: {
                    'Authorization': 'Bearer ' + ew.API_JWT_TOKEN
                }
