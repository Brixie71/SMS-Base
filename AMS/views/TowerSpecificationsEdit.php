...
?>
<main class="edit">
<form name="ftower_specificationsedit" id="ftower_specificationsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { tower_specifications: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var ftower_specificationsedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("ftower_specificationsedit")
        .setPageId("edit")
...
<?php if ($Page->spec_id->Visible) { // spec_id ?>
    <div id="r_spec_id"<?= $Page->spec_id->rowAttributes() ?>>
        <label id="elh_tower_specifications_spec_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->spec_id->caption() ?><?= $Page->spec_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="tower_specifications" data-field="x_spec_id" data-hidden="1" name="x_spec_id" id="x_spec_id" value="<?= HtmlEncode($Page->spec_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["ftower_specificationsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftower_specificationsedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ftower_specificationsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftower_specificationsedit", "x_updated_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="ftower_specificationsedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="ftower_specificationsedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
