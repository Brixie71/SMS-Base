...
$Page->showMessage();
?>
<form name="fmaintenance_logsadd" id="fmaintenance_logsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script>
loadjs.ready(["fmaintenance_logsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmaintenance_logsadd", "x_start_time", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmaintenance_logsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmaintenance_logsadd", "x_end_time", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmaintenance_logsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmaintenance_logsadd", "x_next_maintenance_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmaintenance_logsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmaintenance_logsadd", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmaintenance_logsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmaintenance_logsadd", "x_updated_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fmaintenance_logsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fmaintenance_logsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
