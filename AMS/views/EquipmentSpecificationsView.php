...
// Page object
$EquipmentSpecificationsView = &$Page;
?>
...
?>
<main class="view">
<form name="fequipment_specificationsview" id="fequipment_specificationsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
var currentForm;
var fequipment_specificationsview;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fequipment_specificationsview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->spec_id->Visible) { // spec_id ?>
    <tr id="r_spec_id"<?= $Page->spec_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_spec_id"><?= $Page->spec_id->caption() ?></span></td>
...
<?php if ($Page->equipment_id->Visible) { // equipment_id ?>
    <tr id="r_equipment_id"<?= $Page->equipment_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_equipment_id"><?= $Page->equipment_id->caption() ?></span></td>
...
<?php if ($Page->spec_type_id->Visible) { // spec_type_id ?>
    <tr id="r_spec_type_id"<?= $Page->spec_type_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_spec_type_id"><?= $Page->spec_type_id->caption() ?></span></td>
...
<?php if ($Page->value->Visible) { // value ?>
    <tr id="r_value"<?= $Page->value->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_value"><?= $Page->value->caption() ?></span></td>
...
<?php if ($Page->unit_id->Visible) { // unit_id ?>
    <tr id="r_unit_id"<?= $Page->unit_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_unit_id"><?= $Page->unit_id->caption() ?></span></td>
...
<?php if ($Page->created_by->Visible) { // created_by ?>
    <tr id="r_created_by"<?= $Page->created_by->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_created_by"><?= $Page->created_by->caption() ?></span></td>
...
<?php if ($Page->created_at->Visible) { // created_at ?>
    <tr id="r_created_at"<?= $Page->created_at->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_created_at"><?= $Page->created_at->caption() ?></span></td>
...
<?php if ($Page->updated_by->Visible) { // updated_by ?>
    <tr id="r_updated_by"<?= $Page->updated_by->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_updated_by"><?= $Page->updated_by->caption() ?></span></td>
...
<?php if ($Page->updated_at->Visible) { // updated_at ?>
    <tr id="r_updated_at"<?= $Page->updated_at->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_equipment_specifications_updated_at"><?= $Page->updated_at->caption() ?></span></td>
