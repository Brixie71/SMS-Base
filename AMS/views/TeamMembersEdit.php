...
?>
<main class="edit">
<form name="fteam_membersedit" id="fteam_membersedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { team_members: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fteam_membersedit;
...
<input type="hidden" data-table="team_members" data-field="x_team_id" data-hidden="1" data-old name="o_team_id" id="o_team_id" value="<?= HtmlEncode($Page->team_id->OldValue ?? $Page->team_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="team_members" data-field="x_user_id" data-hidden="1" data-old name="o_user_id" id="o_user_id" value="<?= HtmlEncode($Page->user_id->OldValue ?? $Page->user_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fteam_membersedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fteam_membersedit", "x_assigned_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fteam_membersedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fteam_membersedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fteam_membersedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fteam_membersedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
