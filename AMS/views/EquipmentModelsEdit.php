...
?>
<main class="edit">
<form name="fequipment_modelsedit" id="fequipment_modelsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { equipment_models: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fequipment_modelsedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fequipment_modelsedit")
        .setPageId("edit")

        // Add fields
        .setFields([
            ["model_id", [fields.model_id.visible && fields.model_id.required ? ew.Validators.required(fields.model_id.caption) : null], fields.model_id.isInvalid],
...
<?php if ($Page->model_id->Visible) { // model_id ?>
    <div id="r_model_id"<?= $Page->model_id->rowAttributes() ?>>
        <label id="elh_equipment_models_model_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->model_id->caption() ?><?= $Page->model_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->model_id->getDisplayValue($Page->model_id->EditValue))) ?>"></span>
<input type="hidden" data-table="equipment_models" data-field="x_model_id" data-hidden="1" name="x_model_id" id="x_model_id" value="<?= HtmlEncode($Page->model_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fequipment_modelsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fequipment_modelsedit", "x_support_end_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fequipment_modelsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fequipment_modelsedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fequipment_modelsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fequipment_modelsedit", "x_updated_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fequipment_modelsedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fequipment_modelsedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
