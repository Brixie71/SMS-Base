...
return [
    ...
    "UPLOAD_TEMP_PATH" => "D:/Projects/NLEX/SHIELD/temp_uploads/", // Upload temp path (absolute local physical path)
    "UPLOAD_TEMP_HREF_PATH" => "//nlex-shield.localhost/temp_uploads/", // Upload temp href path (absolute URL path for download)
