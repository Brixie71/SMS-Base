...
/**
 * Entity class for "equipment_specifications" table
 */
#[Entity]
#[Table(name: "equipment_specifications")]
class EquipmentSpecification extends AbstractEntity
{
    #[Id]
    #[Column(name: "spec_id", type: "integer", unique: true)]
    #[GeneratedValue(strategy: "SEQUENCE")]
    #[SequenceGenerator(sequenceName: "equipment_specifications_spec_id_seq")]
    private int $specId;
