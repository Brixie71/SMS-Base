...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/AMS.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\AMS\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\AMS\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-ams", // Export folder
