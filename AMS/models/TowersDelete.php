 ...
 * Page class
 */
class TowersDelete extends Towers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TowersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TowersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TowersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TowersList"); // Return to list
                return;
            }
        }
