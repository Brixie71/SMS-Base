 ...
 * Page class
 */
class MaintenanceSchedulesView extends MaintenanceSchedules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceSchedulesView";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceSchedulesView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("schedule_id") ?? Route("schedule_id")) !== null) {
            $this->RecKey["schedule_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("schedule_id") ?? Route("schedule_id")) !== null) {
            ...
            $this->RecKey["schedule_id"] = $this->schedule_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->schedule_id->setQueryStringValue($keyValue);
            $this->RecKey["schedule_id"] = $this->schedule_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "MaintenanceSchedulesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MaintenanceSchedulesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
