 ...
 * Page class
 */
class ManufacturersDelete extends Manufacturers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManufacturersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ManufacturersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ManufacturersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ManufacturersList"); // Return to list
                return;
            }
        }
