 ...
 * Page class
 */
class MaintenanceTypesView extends MaintenanceTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("type_id") ?? Route("type_id")) !== null) {
            ...
            $returnUrl = "MaintenanceTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MaintenanceTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
