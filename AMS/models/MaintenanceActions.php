...
/**
 * Table class for maintenance_actions
 */
class MaintenanceActions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "maintenance_actions";
        ...
        // action_id
        $this->action_id = new DbField(
            $this, // Table
            'x_action_id', // Variable name
            'action_id', // Name
            '"action_id"', // Expression
            'CAST("action_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"action_id"', // Virtual expression
            false, // Is virtual
        ...
        $this->action_id->InputTextType = "text";
        $this->action_id->Raw = true;
        $this->action_id->IsAutoIncrement = true; // Autoincrement field
        ...
        $this->action_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->result = new DbField(
            $this, // Table
            'x_result', // Variable name
            'result', // Name
            '"result"', // Expression
            '"result"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"result"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->result->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "maintenance_actions";
    }
    ...
    public function insert(&$rs)
    {
        ...
        try {
            ...
            $result = $conn->executeQuery(
                $queryBuilder->getSQL() . " RETURNING action_id",
        ...
        if ($result) {
            $this->action_id->setDbValue($result);
            $rs['action_id'] = $this->action_id->DbValue;
        }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['action_id']) && !EmptyValue($this->action_id->CurrentValue)) {
                $rs['action_id'] = $this->action_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            ...
            $val = !EmptyValue($this->action_id->OldValue) && !$current ? $this->action_id->OldValue : $this->action_id->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MaintenanceActionsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "MaintenanceActionsView" => $Language->phrase("View"),
            "MaintenanceActionsEdit" => $Language->phrase("Edit"),
            "MaintenanceActionsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MaintenanceActionsView",
            Config("API_ADD_ACTION") => "MaintenanceActionsAdd",
            Config("API_EDIT_ACTION") => "MaintenanceActionsEdit",
            Config("API_DELETE_ACTION") => "MaintenanceActionsDelete",
            Config("API_LIST_ACTION") => "MaintenanceActionsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MaintenanceActionsView", $parm);
        } else {
            $url = $this->keyUrl("MaintenanceActionsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MaintenanceActionsAdd?" . $parm;
        } else {
            $url = "MaintenanceActionsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceActionsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceActionsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceActionsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceActionsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MaintenanceActionsDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"action_id\":" . VarToJson($this->action_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->action_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->action_id->CurrentValue);
        } else {
    ...
    {
        global $Response;
        $listPage = "MaintenanceActionsList";
