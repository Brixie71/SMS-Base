 ...
 * Page class
 */
class MaintenanceActionsAdd extends MaintenanceActions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceActionsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceActionsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MaintenanceActionsView") {
