 ...
 * Page class
 */
class MaintenanceActionsEdit extends MaintenanceActions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceActionsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceActionsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("MaintenanceActionsList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "MaintenanceActionsList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "MaintenanceActionsList") {
                            ...
                            $returnUrl = "MaintenanceActionsList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    public function renderRow()
    {
        ...
        // action_id
        $this->action_id->RowCssClass = "row";

        // log_id
        $this->log_id->RowCssClass = "row";

        // action_type
        $this->action_type->RowCssClass = "row";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // action_id
            $this->action_id->setupEditAttributes();
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->action_id->Visible && $this->action_id->Required) {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("MaintenanceActionsList"), "", $this->TableVar, true);
        $pageId = "edit";
