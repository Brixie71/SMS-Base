 ...
 * Page class
 */
class EquipmentSpecificationsView extends EquipmentSpecifications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipmentSpecificationsView";
    ...
    // CSS class/style
    public $CurrentPageName = "EquipmentSpecificationsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("spec_id") ?? Route("spec_id")) !== null) {
            ...
            $returnUrl = "EquipmentSpecificationsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EquipmentSpecificationsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
