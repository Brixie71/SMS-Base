 ...
 * Page class
 */
class EquipmentModelsView extends EquipmentModels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipmentModelsView";
    ...
    // CSS class/style
    public $CurrentPageName = "EquipmentModelsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("model_id") ?? Route("model_id")) !== null) {
            ...
            $returnUrl = "EquipmentModelsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EquipmentModelsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
