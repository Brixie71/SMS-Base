 ...
 * Page class
 */
class MaintenanceSchedulesDelete extends MaintenanceSchedules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceSchedulesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceSchedulesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MaintenanceSchedulesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MaintenanceSchedulesList"); // Return to list
                return;
            }
        }
