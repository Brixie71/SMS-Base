 ...
 * Page class
 */
class TowerEquipmentView extends TowerEquipment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TowerEquipmentView";
    ...
    // CSS class/style
    public $CurrentPageName = "TowerEquipmentView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("equipment_id") ?? Route("equipment_id")) !== null) {
            $this->RecKey["equipment_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("equipment_id") ?? Route("equipment_id")) !== null) {
            ...
            $this->RecKey["equipment_id"] = $this->equipment_id->QueryStringValue;
        } elseif (Post("equipment_id") !== null) {
            $this->equipment_id->setFormValue(Post("equipment_id"));
            $this->RecKey["equipment_id"] = $this->equipment_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->equipment_id->setQueryStringValue($keyValue);
            $this->RecKey["equipment_id"] = $this->equipment_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "TowerEquipmentList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TowerEquipmentList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
