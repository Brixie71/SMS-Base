 ...
 * Page class
 */
class MaintenanceTypesAdd extends MaintenanceTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceTypesAdd";
    ...
    public function setVisibility()
    {
        ...
        $this->checklist_items->setVisibility();
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("MaintenanceTypesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MaintenanceTypesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MaintenanceTypesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "MaintenanceTypesList") {
                            ...
                            $returnUrl = "MaintenanceTypesList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'checklist_items' first before field var 'x_checklist_items'
        $val = $CurrentForm->hasValue("checklist_items") ? $CurrentForm->getValue("checklist_items") : $CurrentForm->getValue("x_checklist_items");
        if (!$this->checklist_items->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->checklist_items->Visible = false; // Disable update for API request
            } else {
                $this->checklist_items->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->checklist_items->CurrentValue = $this->checklist_items->FormValue;
    ...
    public function renderRow()
    {
        ...
        // checklist_items
        $this->checklist_items->RowCssClass = "row";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->checklist_items->EditValue = HtmlEncode($this->checklist_items->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->checklist_items->Visible && $this->checklist_items->Required) {
                if (!$this->checklist_items->IsDetailKey && EmptyValue($this->checklist_items->FormValue)) {
                    $this->checklist_items->addErrorMessage(str_replace("%s", $this->checklist_items->caption(), $this->checklist_items->RequiredErrorMessage));
                }
            }
    ...
    protected function getAddRow()
    {
        ...
        // estimated_duration
        $this->estimated_duration->setDbValueDef($rsnew, $this->estimated_duration->CurrentValue, false);

        // checklist_items
        $this->checklist_items->setDbValueDef($rsnew, $this->checklist_items->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['estimated_duration'])) { // estimated_duration
            $this->estimated_duration->setFormValue($row['estimated_duration']);
        }
        if (isset($row['checklist_items'])) { // checklist_items
            $this->checklist_items->setFormValue($row['checklist_items']);
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("MaintenanceTypesList"), "", $this->TableVar, true);
