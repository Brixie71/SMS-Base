 ...
 * Page class
 */
class MaintenanceTypesEdit extends MaintenanceTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceTypesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceTypesEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // checklist_items
        $this->checklist_items->setDbValueDef($rsnew, $this->checklist_items->CurrentValue, $this->checklist_items->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['checklist_items'])) { // checklist_items
            $this->checklist_items->CurrentValue = $row['checklist_items'];
        }
