 ...
 * Page class
 */
class EquipmentModelsAdd extends EquipmentModels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipmentModelsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "EquipmentModelsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "EquipmentModelsView") {
    ...
    protected function getAddRow()
    {
        ...
        // manufacturer_id
        $this->manufacturer_id->setDbValueDef($rsnew, $this->manufacturer_id->CurrentValue, false);

        // type_id
        $this->type_id->setDbValueDef($rsnew, $this->type_id->CurrentValue, false);

        // model_number
        $this->model_number->setDbValueDef($rsnew, $this->model_number->CurrentValue, false);
        ...
        // specifications
        $this->specifications->setDbValueDef($rsnew, $this->specifications->CurrentValue, false);

        // support_end_date
        $this->support_end_date->setDbValueDef($rsnew, UnFormatDateTime($this->support_end_date->CurrentValue, $this->support_end_date->formatPattern()), false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['specifications'])) { // specifications
            $this->specifications->setFormValue($row['specifications']);
        }
        if (isset($row['support_end_date'])) { // support_end_date
            $this->support_end_date->setFormValue($row['support_end_date']);
        }
