...
/**
 * Table class for tower_specifications
 */
class TowerSpecifications extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "tower_specifications";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tower_specifications";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TowerSpecificationsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TowerSpecificationsView" => $Language->phrase("View"),
            "TowerSpecificationsEdit" => $Language->phrase("Edit"),
            "TowerSpecificationsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "TowerSpecificationsList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TowerSpecificationsView",
            Config("API_ADD_ACTION") => "TowerSpecificationsAdd",
            Config("API_EDIT_ACTION") => "TowerSpecificationsEdit",
            Config("API_DELETE_ACTION") => "TowerSpecificationsDelete",
            Config("API_LIST_ACTION") => "TowerSpecificationsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TowerSpecificationsView", $parm);
        } else {
            $url = $this->keyUrl("TowerSpecificationsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TowerSpecificationsAdd?" . $parm;
        } else {
            $url = "TowerSpecificationsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TowerSpecificationsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TowerSpecificationsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TowerSpecificationsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TowerSpecificationsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TowerSpecificationsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "TowerSpecificationsList";
