 ...
 * Page class
 */
class MaintenanceTeamsView extends MaintenanceTeams
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceTeamsView";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceTeamsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("team_id") ?? Route("team_id")) !== null) {
            ...
            $this->RecKey["team_id"] = $this->team_id->QueryStringValue;
        } elseif (Post("team_id") !== null) {
            $this->team_id->setFormValue(Post("team_id"));
            $this->RecKey["team_id"] = $this->team_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->team_id->setQueryStringValue($keyValue);
            $this->RecKey["team_id"] = $this->team_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "MaintenanceTeamsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MaintenanceTeamsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
