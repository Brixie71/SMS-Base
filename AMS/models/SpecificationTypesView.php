 ...
 * Page class
 */
class SpecificationTypesView extends SpecificationTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SpecificationTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "SpecificationTypesView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("spec_type_id") ?? Route("spec_type_id")) !== null) {
            $this->RecKey["spec_type_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("spec_type_id") ?? Route("spec_type_id")) !== null) {
            ...
            $this->RecKey["spec_type_id"] = $this->spec_type_id->QueryStringValue;
        } elseif (Post("spec_type_id") !== null) {
            $this->spec_type_id->setFormValue(Post("spec_type_id"));
            $this->RecKey["spec_type_id"] = $this->spec_type_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->spec_type_id->setQueryStringValue($keyValue);
            $this->RecKey["spec_type_id"] = $this->spec_type_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "SpecificationTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SpecificationTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
