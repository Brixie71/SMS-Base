 ...
 * Page class
 */
class UnitCategoriesView extends UnitCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UnitCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "UnitCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("category_id") ?? Route("category_id")) !== null) {
            ...
            $returnUrl = "UnitCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UnitCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
