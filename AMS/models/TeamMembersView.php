 ...
 * Page class
 */
class TeamMembersView extends TeamMembers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TeamMembersView";
    ...
    // CSS class/style
    public $CurrentPageName = "TeamMembersView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("team_id") ?? Route("team_id")) !== null) {
            ...
            $returnUrl = "TeamMembersList"; // Return to list
        }
        if (($keyValue = Get("user_id") ?? Route("user_id")) !== null) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TeamMembersList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
