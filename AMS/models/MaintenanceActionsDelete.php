 ...
 * Page class
 */
class MaintenanceActionsDelete extends MaintenanceActions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceActionsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceActionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MaintenanceActionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MaintenanceActionsList"); // Return to list
                return;
            }
        }
