 ...
 * Page class
 */
class TowerEquipmentAdd extends TowerEquipment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TowerEquipmentAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TowerEquipmentAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TowerEquipmentView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->serial_number->CurrentValue != "") { // Check field with unique index
            $filter = "(\"serial_number\" = '" . AdjustSql($this->serial_number->CurrentValue, $this->Dbid) . "')";
    ...
    protected function getAddRow()
    {
        ...
        // model_id
        $this->model_id->setDbValueDef($rsnew, $this->model_id->CurrentValue, false);
        ...
        // warranty_expiry
        $this->warranty_expiry->setDbValueDef($rsnew, UnFormatDateTime($this->warranty_expiry->CurrentValue, $this->warranty_expiry->formatPattern()), false);
        ...
        // next_maintenance
        $this->next_maintenance->setDbValueDef($rsnew, UnFormatDateTime($this->next_maintenance->CurrentValue, $this->next_maintenance->formatPattern()), false);

        // client_id
        $this->client_id->setDbValueDef($rsnew, $this->client_id->CurrentValue, false);

        // installed_by
        $this->installed_by->setDbValueDef($rsnew, $this->installed_by->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['model_id'])) { // model_id
            $this->model_id->setFormValue($row['model_id']);
        }
        if (isset($row['serial_number'])) { // serial_number
            $this->serial_number->setFormValue($row['serial_number']);
        }
        ...
        if (isset($row['warranty_expiry'])) { // warranty_expiry
            $this->warranty_expiry->setFormValue($row['warranty_expiry']);
        }
