 ...
 * Page class
 */
class MaintenanceActionsView extends MaintenanceActions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceActionsView";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceActionsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("action_id") ?? Route("action_id")) !== null) {
            ...
            $returnUrl = "MaintenanceActionsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MaintenanceActionsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
