 ...
 * Page class
 */
class ManufacturersView extends Manufacturers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManufacturersView";
    ...
    // CSS class/style
    public $CurrentPageName = "ManufacturersView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("manufacturer_id") ?? Route("manufacturer_id")) !== null) {
            $this->RecKey["manufacturer_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("manufacturer_id") ?? Route("manufacturer_id")) !== null) {
            ...
            $this->RecKey["manufacturer_id"] = $this->manufacturer_id->QueryStringValue;
        } elseif (Post("manufacturer_id") !== null) {
            $this->manufacturer_id->setFormValue(Post("manufacturer_id"));
            $this->RecKey["manufacturer_id"] = $this->manufacturer_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->manufacturer_id->setQueryStringValue($keyValue);
            $this->RecKey["manufacturer_id"] = $this->manufacturer_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ManufacturersList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ManufacturersList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
