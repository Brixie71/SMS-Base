 ...
 * Page class
 */
class EquipmentSpecificationsDelete extends EquipmentSpecifications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipmentSpecificationsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EquipmentSpecificationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EquipmentSpecificationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EquipmentSpecificationsList"); // Return to list
                return;
            }
        }
