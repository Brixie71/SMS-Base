 ...
 * Page class
 */
class TowersView extends Towers
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "TowersView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("tower_id") ?? Route("tower_id")) !== null) {
            ...
            $this->RecKey["tower_id"] = $this->tower_id->QueryStringValue;
        } elseif (Post("tower_id") !== null) {
            $this->tower_id->setFormValue(Post("tower_id"));
            $this->RecKey["tower_id"] = $this->tower_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->tower_id->setQueryStringValue($keyValue);
            $this->RecKey["tower_id"] = $this->tower_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "TowersList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TowersList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
