 ...
 * Page class
 */
class TeamMembersAdd extends TeamMembers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TeamMembersAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TeamMembersAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TeamMembersView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['team_id']) == "") {
    ...
    protected function getAddRow()
    {
        ...
        // team_id
        $this->team_id->setDbValueDef($rsnew, $this->team_id->CurrentValue, false);
        ...
        // assigned_date
        $this->assigned_date->setDbValueDef($rsnew, UnFormatDateTime($this->assigned_date->CurrentValue, $this->assigned_date->formatPattern()), false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['team_id'])) { // team_id
            $this->team_id->setFormValue($row['team_id']);
        }
        ...
        if (isset($row['assigned_date'])) { // assigned_date
            $this->assigned_date->setFormValue($row['assigned_date']);
        }
