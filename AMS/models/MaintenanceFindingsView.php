 ...
 * Page class
 */
class MaintenanceFindingsView extends MaintenanceFindings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceFindingsView";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceFindingsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("finding_id") ?? Route("finding_id")) !== null) {
            $this->RecKey["finding_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("finding_id") ?? Route("finding_id")) !== null) {
            ...
            $this->RecKey["finding_id"] = $this->finding_id->QueryStringValue;
        } elseif (Post("finding_id") !== null) {
            $this->finding_id->setFormValue(Post("finding_id"));
            $this->RecKey["finding_id"] = $this->finding_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->finding_id->setQueryStringValue($keyValue);
            $this->RecKey["finding_id"] = $this->finding_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "MaintenanceFindingsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MaintenanceFindingsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
