 ...
 * Page class
 */
class MaintenancePartsView extends MaintenanceParts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenancePartsView";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenancePartsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("part_id") ?? Route("part_id")) !== null) {
            ...
            $this->RecKey["part_id"] = $this->part_id->QueryStringValue;
        } elseif (Post("part_id") !== null) {
            $this->part_id->setFormValue(Post("part_id"));
            $this->RecKey["part_id"] = $this->part_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->part_id->setQueryStringValue($keyValue);
            $this->RecKey["part_id"] = $this->part_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "MaintenancePartsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MaintenancePartsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
