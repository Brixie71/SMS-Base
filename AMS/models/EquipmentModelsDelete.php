 ...
 * Page class
 */
class EquipmentModelsDelete extends EquipmentModels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipmentModelsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EquipmentModelsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EquipmentModelsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EquipmentModelsList"); // Return to list
                return;
            }
        }
