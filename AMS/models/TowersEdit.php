 ...
 * Page class
 */
class TowersEdit extends Towers
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "TowersEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("tower_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->tower_id->setQueryStringValue($keyValue);
                $this->tower_id->setOldValue($this->tower_id->QueryStringValue);
            } elseif (Post("tower_id") !== null) {
                $this->tower_id->setFormValue(Post("tower_id"));
                $this->tower_id->setOldValue($this->tower_id->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("tower_id") ?? Route("tower_id")) !== null) {
                    ...
                    $this->tower_id->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->tower_id->IsDetailKey) {
            $this->tower_id->setFormValue($val);
        }
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (code)
