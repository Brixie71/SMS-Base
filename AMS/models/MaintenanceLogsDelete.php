 ...
 * Page class
 */
class MaintenanceLogsDelete extends MaintenanceLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceLogsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceLogsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MaintenanceLogsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MaintenanceLogsList"); // Return to list
                return;
            }
        }
