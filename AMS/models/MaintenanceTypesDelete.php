 ...
 * Page class
 */
class MaintenanceTypesDelete extends MaintenanceTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceTypesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceTypesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MaintenanceTypesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MaintenanceTypesList"); // Return to list
                return;
            }
        }
