 ...
 * Page class
 */
class MaintenanceSchedulesAdd extends MaintenanceSchedules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceSchedulesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceSchedulesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MaintenanceSchedulesView") {
    ...
    protected function getAddRow()
    {
        ...
        // maintenance_type_id
        $this->maintenance_type_id->setDbValueDef($rsnew, $this->maintenance_type_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['maintenance_type_id'])) { // maintenance_type_id
            $this->maintenance_type_id->setFormValue($row['maintenance_type_id']);
        }
