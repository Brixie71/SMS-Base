 ...
 * Page class
 */
class TowerSpecificationsView extends TowerSpecifications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TowerSpecificationsView";
    ...
    // CSS class/style
    public $CurrentPageName = "TowerSpecificationsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("spec_id") ?? Route("spec_id")) !== null) {
            ...
            $returnUrl = "TowerSpecificationsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TowerSpecificationsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
