...
/**
 * Table class for maintenance_parts
 */
class MaintenanceParts extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "maintenance_parts";
        ...
        // part_id
        $this->part_id = new DbField(
            $this, // Table
            'x_part_id', // Variable name
            'part_id', // Name
            '"part_id"', // Expression
            'CAST("part_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"part_id"', // Virtual expression
            false, // Is virtual
        ...
        $this->part_id->InputTextType = "text";
        $this->part_id->Raw = true;
        $this->part_id->IsAutoIncrement = true; // Autoincrement field
        $this->part_id->IsPrimaryKey = true; // Primary key field
        $this->part_id->Nullable = false; // NOT NULL field
        $this->part_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->part_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['part_id'] = &$this->part_id;
        ...
        // part_name
        $this->part_name = new DbField(
            $this, // Table
            'x_part_name', // Variable name
            'part_name', // Name
            '"part_name"', // Expression
            '"part_name"', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"part_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->part_name->InputTextType = "text";
        $this->part_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // unit_cost
        $this->unit_cost = new DbField(
            $this, // Table
            'x_unit_cost', // Variable name
            'unit_cost', // Name
            '"unit_cost"', // Expression
            'CAST("unit_cost" AS varchar(255))', // Basic search expression
            14, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"unit_cost"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->unit_cost->InputTextType = "text";
        $this->unit_cost->Raw = true;
        $this->unit_cost->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->unit_cost->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['unit_cost'] = &$this->unit_cost;

        // total_cost
        $this->total_cost = new DbField(
            $this, // Table
            'x_total_cost', // Variable name
            'total_cost', // Name
            '"total_cost"', // Expression
            'CAST("total_cost" AS varchar(255))', // Basic search expression
            14, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"total_cost"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->total_cost->InputTextType = "text";
        $this->total_cost->Raw = true;
        $this->total_cost->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->total_cost->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        // warranty_period
        $this->warranty_period = new DbField(
            $this, // Table
            'x_warranty_period', // Variable name
            'warranty_period', // Name
            '"warranty_period"', // Expression
            'CAST("warranty_period" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"warranty_period"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->warranty_period->InputTextType = "text";
        $this->warranty_period->Raw = true;
        $this->warranty_period->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->warranty_period->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['warranty_period'] = &$this->warranty_period;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "maintenance_parts";
    }
    ...
    public function insert(&$rs)
    {
        ...
        try {
            ...
            $result = $conn->executeQuery(
                $queryBuilder->getSQL() . " RETURNING part_id",
        ...
        if ($result) {
            $this->part_id->setDbValue($result);
            $rs['part_id'] = $this->part_id->DbValue;
        }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['part_id']) && !EmptyValue($this->part_id->CurrentValue)) {
                $rs['part_id'] = $this->part_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('part_id', $rs)) {
                AddFilter($where, QuotedName('part_id', $this->Dbid) . '=' . QuotedValue($rs['part_id'], $this->part_id->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->part_id->DbValue = $row['part_id'];
        ...
        $this->warranty_period->DbValue = $row['warranty_period'];
    ...
    {
        $keys = [];
        $val = $current ? $this->part_id->CurrentValue : $this->part_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->part_id->CurrentValue = $keys[0];
            } else {
                $this->part_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('part_id', $row) ? $row['part_id'] : null;
        } else {
            $val = !EmptyValue($this->part_id->OldValue) && !$current ? $this->part_id->OldValue : $this->part_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@part_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MaintenancePartsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "MaintenancePartsView" => $Language->phrase("View"),
            "MaintenancePartsEdit" => $Language->phrase("Edit"),
            "MaintenancePartsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MaintenancePartsView",
            Config("API_ADD_ACTION") => "MaintenancePartsAdd",
            Config("API_EDIT_ACTION") => "MaintenancePartsEdit",
            Config("API_DELETE_ACTION") => "MaintenancePartsDelete",
            Config("API_LIST_ACTION") => "MaintenancePartsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MaintenancePartsView", $parm);
        } else {
            $url = $this->keyUrl("MaintenancePartsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MaintenancePartsAdd?" . $parm;
        } else {
            $url = "MaintenancePartsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenancePartsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenancePartsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenancePartsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenancePartsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MaintenancePartsDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"part_id\":" . VarToJson($this->part_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->part_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->part_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("part_id") ?? Route("part_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->part_id->CurrentValue = $key;
            } else {
                $this->part_id->OldValue = $key;
            }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->part_id);
                    $doc->exportCaption($this->log_id);
                    $doc->exportCaption($this->part_name);
                    $doc->exportCaption($this->quantity);
                    $doc->exportCaption($this->unit_cost);
                    $doc->exportCaption($this->total_cost);
                    $doc->exportCaption($this->supplier);
                    $doc->exportCaption($this->warranty_period);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->part_id);
                        $doc->exportField($this->log_id);
                        $doc->exportField($this->part_name);
                        $doc->exportField($this->quantity);
                        $doc->exportField($this->unit_cost);
                        $doc->exportField($this->total_cost);
                        $doc->exportField($this->supplier);
                        $doc->exportField($this->warranty_period);
