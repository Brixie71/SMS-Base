 ...
 * Page class
 */
class MaintenanceFindingsDelete extends MaintenanceFindings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceFindingsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceFindingsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MaintenanceFindingsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MaintenanceFindingsList"); // Return to list
                return;
            }
        }
