 ...
 * Page class
 */
class MaintenancePartsDelete extends MaintenanceParts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenancePartsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenancePartsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MaintenancePartsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MaintenancePartsList"); // Return to list
                return;
            }
        }
