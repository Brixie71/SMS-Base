...
/**
 * Table class for maintenance_types
 */
class MaintenanceTypes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "maintenance_types";
        ...
        // checklist_items
        $this->checklist_items = new DbField(
            $this, // Table
            'x_checklist_items', // Variable name
            'checklist_items', // Name
            '"checklist_items"', // Expression
            'CAST("checklist_items" AS varchar(255))', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"checklist_items"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->checklist_items->InputTextType = "text";
        $this->checklist_items->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['checklist_items'] = &$this->checklist_items;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "maintenance_types";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->checklist_items->DbValue = $row['checklist_items'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MaintenanceTypesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "MaintenanceTypesView" => $Language->phrase("View"),
            "MaintenanceTypesEdit" => $Language->phrase("Edit"),
            "MaintenanceTypesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MaintenanceTypesView",
            Config("API_ADD_ACTION") => "MaintenanceTypesAdd",
            Config("API_EDIT_ACTION") => "MaintenanceTypesEdit",
            Config("API_DELETE_ACTION") => "MaintenanceTypesDelete",
            Config("API_LIST_ACTION") => "MaintenanceTypesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MaintenanceTypesView", $parm);
        } else {
            $url = $this->keyUrl("MaintenanceTypesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MaintenanceTypesAdd?" . $parm;
        } else {
            $url = "MaintenanceTypesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceTypesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceTypesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceTypesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MaintenanceTypesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MaintenanceTypesDelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        // checklist_items
        $this->checklist_items->ViewValue = $this->checklist_items->CurrentValue;
        ...
        // checklist_items
        $this->checklist_items->HrefValue = "";
        $this->checklist_items->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // checklist_items
        $this->checklist_items->setupEditAttributes();
        $this->checklist_items->EditValue = $this->checklist_items->CurrentValue;
        $this->checklist_items->PlaceHolder = RemoveHtml($this->checklist_items->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->checklist_items);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->checklist_items);
