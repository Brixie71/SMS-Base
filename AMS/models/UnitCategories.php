...
/**
 * Table class for unit_categories
 */
class UnitCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "unit_categories";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "unit_categories";
    }
    ...
    public function insert(&$rs)
    {
        ...
        try {
            ...
            $result = $conn->executeQuery(
                $queryBuilder->getSQL() . " RETURNING category_id",
        ...
        if ($result) {
            $this->category_id->setDbValue($result);
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UnitCategoriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "UnitCategoriesView" => $Language->phrase("View"),
            "UnitCategoriesEdit" => $Language->phrase("Edit"),
            "UnitCategoriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "UnitCategoriesView",
            Config("API_ADD_ACTION") => "UnitCategoriesAdd",
            Config("API_EDIT_ACTION") => "UnitCategoriesEdit",
            Config("API_DELETE_ACTION") => "UnitCategoriesDelete",
            Config("API_LIST_ACTION") => "UnitCategoriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UnitCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("UnitCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "UnitCategoriesAdd?" . $parm;
        } else {
            $url = "UnitCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UnitCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UnitCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UnitCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UnitCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("UnitCategoriesDelete", $parm);
        }
    }
