 ...
 * Page class
 */
class MaintenanceFindingsAdd extends MaintenanceFindings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceFindingsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceFindingsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MaintenanceFindingsView") {
    ...
    protected function getAddRow()
    {
        ...
        // finding_type
        $this->finding_type->setDbValueDef($rsnew, $this->finding_type->CurrentValue, false);

        // description
        $this->description->setDbValueDef($rsnew, $this->description->CurrentValue, false);

        // severity
        $this->severity->setDbValueDef($rsnew, $this->severity->CurrentValue, false);

        // recommendation
        $this->recommendation->setDbValueDef($rsnew, $this->recommendation->CurrentValue, false);
