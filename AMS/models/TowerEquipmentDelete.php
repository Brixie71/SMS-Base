 ...
 * Page class
 */
class TowerEquipmentDelete extends TowerEquipment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TowerEquipmentDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TowerEquipmentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TowerEquipmentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TowerEquipmentList"); // Return to list
                return;
            }
        }
