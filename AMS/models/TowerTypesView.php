 ...
 * Page class
 */
class TowerTypesView extends TowerTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TowerTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TowerTypesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("type_id") ?? Route("type_id")) !== null) {
            ...
            $returnUrl = "TowerTypesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TowerTypesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
