 ...
 * Page class
 */
class ManufacturersAdd extends Manufacturers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManufacturersAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ManufacturersAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ManufacturersView") {
    ...
    protected function getAddRow()
    {
        ...
        // support_contact
        $this->support_contact->setDbValueDef($rsnew, $this->support_contact->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['support_contact'])) { // support_contact
            $this->support_contact->setFormValue($row['support_contact']);
        }
