 ...
 * Page class
 */
class SpecificationTypesAdd extends SpecificationTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SpecificationTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "SpecificationTypesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SpecificationTypesView") {
    ...
    protected function getAddRow()
    {
        ...
        // unit_category_id
        $this->unit_category_id->setDbValueDef($rsnew, $this->unit_category_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['unit_category_id'])) { // unit_category_id
            $this->unit_category_id->setFormValue($row['unit_category_id']);
        }
