 ...
 * Page class
 */
class MaintenanceSchedulesList extends MaintenanceSchedules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceSchedulesList";
    ...
    public $FormName = "fmaintenance_scheduleslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "MaintenanceSchedulesList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "MaintenanceSchedulesAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "MaintenanceSchedulesDelete";
        $this->MultiUpdateUrl = "MaintenanceSchedulesUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fmaintenance_schedulesgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fmaintenance_schedulessrch");
        }
        $filterList = Concat($filterList, $this->schedule_id->AdvancedSearch->toJson(), ","); // Field schedule_id
        $filterList = Concat($filterList, $this->equipment_id->AdvancedSearch->toJson(), ","); // Field equipment_id
        $filterList = Concat($filterList, $this->maintenance_type_id->AdvancedSearch->toJson(), ","); // Field maintenance_type_id
        ...
        $filterList = Concat($filterList, $this->estimated_duration->AdvancedSearch->toJson(), ","); // Field estimated_duration
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fmaintenance_schedulessrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field schedule_id
        $this->schedule_id->AdvancedSearch->SearchValue = @$filter["x_schedule_id"];
        $this->schedule_id->AdvancedSearch->SearchOperator = @$filter["z_schedule_id"];
        $this->schedule_id->AdvancedSearch->SearchCondition = @$filter["v_schedule_id"];
        $this->schedule_id->AdvancedSearch->SearchValue2 = @$filter["y_schedule_id"];
        $this->schedule_id->AdvancedSearch->SearchOperator2 = @$filter["w_schedule_id"];
        $this->schedule_id->AdvancedSearch->save();
        ...
        $this->maintenance_type_id->AdvancedSearch->SearchValue = @$filter["x_maintenance_type_id"];
        $this->maintenance_type_id->AdvancedSearch->SearchOperator = @$filter["z_maintenance_type_id"];
        $this->maintenance_type_id->AdvancedSearch->SearchCondition = @$filter["v_maintenance_type_id"];
        $this->maintenance_type_id->AdvancedSearch->SearchValue2 = @$filter["y_maintenance_type_id"];
        $this->maintenance_type_id->AdvancedSearch->SearchOperator2 = @$filter["w_maintenance_type_id"];
        $this->maintenance_type_id->AdvancedSearch->save();
        ...
        $this->estimated_duration->AdvancedSearch->SearchValue = @$filter["x_estimated_duration"];
        $this->estimated_duration->AdvancedSearch->SearchOperator = @$filter["z_estimated_duration"];
        $this->estimated_duration->AdvancedSearch->SearchCondition = @$filter["v_estimated_duration"];
        $this->estimated_duration->AdvancedSearch->SearchValue2 = @$filter["y_estimated_duration"];
        $this->estimated_duration->AdvancedSearch->SearchOperator2 = @$filter["w_estimated_duration"];
        $this->estimated_duration->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->maintenance_type_id); // maintenance_type_id
            ...
            $this->updateSort($this->estimated_duration); // estimated_duration
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"maintenance_schedules\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"maintenance_schedules\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"maintenance_schedules\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmaintenance_scheduleslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmaintenance_scheduleslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->schedule_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"maintenance_schedules\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "schedule_id");
            $this->createColumnOption($option, "equipment_id");
            $this->createColumnOption($option, "maintenance_type_id");
            $this->createColumnOption($option, "team_id");
            ...
            $this->createColumnOption($option, "estimated_duration");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmaintenance_schedulessrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmaintenance_schedulessrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmaintenance_scheduleslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_maintenance_schedules", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_maintenance_schedules",
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmaintenance_schedulessrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
