 ...
 * Page class
 */
class TowerSpecificationsDelete extends TowerSpecifications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TowerSpecificationsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TowerSpecificationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TowerSpecificationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TowerSpecificationsList"); // Return to list
                return;
            }
        }
