 ...
 * Page class
 */
class MaintenanceLogsView extends MaintenanceLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceLogsView";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceLogsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("log_id") ?? Route("log_id")) !== null) {
            ...
            $returnUrl = "MaintenanceLogsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MaintenanceLogsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
