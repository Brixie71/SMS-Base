 ...
 * Page class
 */
class EquipmentModelsList extends EquipmentModels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipmentModelsList";
    ...
    public $FormName = "fequipment_modelslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "EquipmentModelsList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "EquipmentModelsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "EquipmentModelsDelete";
        $this->MultiUpdateUrl = "EquipmentModelsUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fequipment_modelsgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fequipment_modelssrch");
        }
        $filterList = Concat($filterList, $this->model_id->AdvancedSearch->toJson(), ","); // Field model_id
        $filterList = Concat($filterList, $this->manufacturer_id->AdvancedSearch->toJson(), ","); // Field manufacturer_id
        $filterList = Concat($filterList, $this->type_id->AdvancedSearch->toJson(), ","); // Field type_id
        $filterList = Concat($filterList, $this->model_number->AdvancedSearch->toJson(), ","); // Field model_number
        $filterList = Concat($filterList, $this->name->AdvancedSearch->toJson(), ","); // Field name
        $filterList = Concat($filterList, $this->description->AdvancedSearch->toJson(), ","); // Field description
        $filterList = Concat($filterList, $this->specifications->AdvancedSearch->toJson(), ","); // Field specifications
        $filterList = Concat($filterList, $this->support_end_date->AdvancedSearch->toJson(), ","); // Field support_end_date
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fequipment_modelssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->manufacturer_id->AdvancedSearch->SearchValue = @$filter["x_manufacturer_id"];
        $this->manufacturer_id->AdvancedSearch->SearchOperator = @$filter["z_manufacturer_id"];
        $this->manufacturer_id->AdvancedSearch->SearchCondition = @$filter["v_manufacturer_id"];
        $this->manufacturer_id->AdvancedSearch->SearchValue2 = @$filter["y_manufacturer_id"];
        $this->manufacturer_id->AdvancedSearch->SearchOperator2 = @$filter["w_manufacturer_id"];
        $this->manufacturer_id->AdvancedSearch->save();
        ...
        // Field model_number
        $this->model_number->AdvancedSearch->SearchValue = @$filter["x_model_number"];
        $this->model_number->AdvancedSearch->SearchOperator = @$filter["z_model_number"];
        $this->model_number->AdvancedSearch->SearchCondition = @$filter["v_model_number"];
        $this->model_number->AdvancedSearch->SearchValue2 = @$filter["y_model_number"];
        $this->model_number->AdvancedSearch->SearchOperator2 = @$filter["w_model_number"];
        $this->model_number->AdvancedSearch->save();
        ...
        $this->specifications->AdvancedSearch->SearchValue = @$filter["x_specifications"];
        $this->specifications->AdvancedSearch->SearchOperator = @$filter["z_specifications"];
        $this->specifications->AdvancedSearch->SearchCondition = @$filter["v_specifications"];
        $this->specifications->AdvancedSearch->SearchValue2 = @$filter["y_specifications"];
        $this->specifications->AdvancedSearch->SearchOperator2 = @$filter["w_specifications"];
        $this->specifications->AdvancedSearch->save();

        // Field support_end_date
        $this->support_end_date->AdvancedSearch->SearchValue = @$filter["x_support_end_date"];
        $this->support_end_date->AdvancedSearch->SearchOperator = @$filter["z_support_end_date"];
        $this->support_end_date->AdvancedSearch->SearchCondition = @$filter["v_support_end_date"];
        $this->support_end_date->AdvancedSearch->SearchValue2 = @$filter["y_support_end_date"];
        $this->support_end_date->AdvancedSearch->SearchOperator2 = @$filter["w_support_end_date"];
        $this->support_end_date->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->model_number;
        $searchFlds[] = &$this->name;
        $searchFlds[] = &$this->description;
        $searchFlds[] = &$this->specifications;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->manufacturer_id); // manufacturer_id
            $this->updateSort($this->type_id); // type_id
            $this->updateSort($this->model_number); // model_number
            $this->updateSort($this->name); // name
            $this->updateSort($this->support_end_date); // support_end_date
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->manufacturer_id->setSort("");
                $this->type_id->setSort("");
                $this->model_number->setSort("");
                $this->name->setSort("");
                $this->description->setSort("");
                $this->specifications->setSort("");
                $this->support_end_date->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"equipment_models\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"equipment_models\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"equipment_models\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fequipment_modelslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fequipment_modelslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->model_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"equipment_models\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "manufacturer_id");
            $this->createColumnOption($option, "type_id");
            $this->createColumnOption($option, "model_number");
            $this->createColumnOption($option, "name");
            $this->createColumnOption($option, "support_end_date");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fequipment_modelssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fequipment_modelssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fequipment_modelslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_equipment_models", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_equipment_models",
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fequipment_modelssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
