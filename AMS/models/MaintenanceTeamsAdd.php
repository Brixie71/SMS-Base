 ...
 * Page class
 */
class MaintenanceTeamsAdd extends MaintenanceTeams
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MaintenanceTeamsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MaintenanceTeamsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MaintenanceTeamsView") {
    ...
    protected function getAddRow()
    {
        ...
        // supervisor_id
        $this->supervisor_id->setDbValueDef($rsnew, $this->supervisor_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['supervisor_id'])) { // supervisor_id
            $this->supervisor_id->setFormValue($row['supervisor_id']);
        }
