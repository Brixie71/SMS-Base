            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        ...
                        <small><?php echo htmlspecialchars($totalUsersChange); ?>% from last month</small>
                    </span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        <?php echo htmlspecialchars($activeUsers); ?>
                        <small><?php echo htmlspecialchars($activeUsersPercent); ?>% of total</small>
                    </span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo htmlspecialchars($totalSystems); ?></span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo htmlspecialchars($totalUserLevels); ?></span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="timeline">
                        ...
                        ?>
                            <div class="time-label">
                                <span class="bg-red"><?php echo htmlspecialchars($log['action_date']); ?></span>
                            </div>
                        <?php 
                            }
                        ?>
                        <div>
                            ...
                            <div class="timeline-item">
                                <span class="time"><i class="fas fa-clock"></i> <?php echo htmlspecialchars($log['action_count']); ?> action<?php echo $log['action_count'] > 1 ? 's' : ''; ?></span>
                                <h3 class="timeline-header"><?php echo htmlspecialchars($log['script']); ?> by <?php echo htmlspecialchars($log['user']); ?></h3>
                                <div class="timeline-body">
                                    <strong><?php echo htmlspecialchars($log['action_type']); ?></strong> on <?php echo htmlspecialchars($log['table']); ?><br>
        ...
        <div class="col-md-4">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <?php echo htmlspecialchars($system['system_name']); ?>
                                <span class="float-right badge bg-primary"><?php echo htmlspecialchars($system['user_count']); ?> users</span>
                            </a>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                ...
                                <span class="float-right text-muted text-sm"><?php echo htmlspecialchars($user['date_created']); ?></span>
                            </a>
                        </li>
                        <?php endforeach; ?>
                    </ul>
            ...
            <div class="card">
                ...
                <div class="card-body  d-grid">
                    <a href="<?php echo htmlspecialchars($createUserUrl); ?>" class="btn btn-primary btn-block mb-3">
                        <i class="fas fa-user-plus mr-2"></i> Create New User
                    </a>
                    <a href="<?php echo htmlspecialchars($manageUserLevelsUrl); ?>" class="btn btn-info btn-block mb-3">
                        <i class="fas fa-users-cog mr-2"></i> Manage User Levels
                    </a>
                    <a href="<?php echo htmlspecialchars($manageSystemsUrl); ?>" class="btn btn-warning btn-block mb-3">
                        <i class="fas fa-cogs mr-2"></i> Manage Systems
                    </a>
                    <a href="<?php echo htmlspecialchars($viewAuditLogsUrl); ?>" class="btn btn-secondary btn-block">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-<?php echo $system['status'] === 'Active' ? 'success' : 'danger'; ?>">
                                        <?php echo htmlspecialchars($system['status']); ?>
                                    </span>
                                </td>
                                <td><?php echo htmlspecialchars($system['active_users']); ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
